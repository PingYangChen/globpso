globpso
=======
This package collects the powerful variants of particle swarm optimization algorithms.  Currently it supports the basic PSO algorithm and the Quantum-behaved PSO algorithm.
